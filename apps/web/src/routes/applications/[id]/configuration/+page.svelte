			...
			>
				...
				<div class="flex flex-col">
					<button
						...
						class="font-medium rounded-md text-sm px-5 py-2.5 text-center inline-flex items-center w-36 mt-2 bg-gray-100 hover:bg-gray-100 focus:ring-2 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
						type="button"
					>
						Docker Hub <svg
